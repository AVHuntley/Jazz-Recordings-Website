...
media:
  lead-belly-march-of-time:
    youtube: QxykqBmUCwk
    title: March of Time, 1935 - Vol.1 Issue 2, March 8, 1935
    caption: One of only two surviving films of Lead Belly. A *staged* depiction of meeting and contracting with Lomax. *March of Time*, 1935 - Vol.1 Issue 2, March 8, 1935
  maple-leaf-rag-roll:
  ...
  eureka-west-lawn-dirge:
    ...
    title: West Lawn Dirge, Eureka Brass Band
    caption: |-
  ...
  bunk-johnson-talking-records:
    spotify: 6CN81N7BUuaOPFznlzxnc2
    title: Bunk Johnson, "Talking Records"
    caption: |-
      Bunk Johnson describes his early musical experiences in New Orleans. Published as "Talking Records" on the album *Bunk Johnson and his Superior Jazz Band*.
intro: |-
  Jazz did not emerge in isolation. Like every style of music, early jazz was a development of existing musical styles and a synthesis of many influences. The earliest jazz musicians—in New Orleans and (to a lesser extent) Chicago and New York—were awash in stylistic influences from African- and European-American musical traditions. Indeed, many of the key characteristics of jazz (especially early jazz) can be plainly heard in these abutting musical styles.

  This section will introduce a few such styles, give a recorded example of each, and discuss what characteristics influenced the development of jazz as a distinct genre. As you listen to the examples, try to hear the musical elements of each that remain in jazz of later years - particularly that from the next lesson ([Early Jazz](./early-jazz.html)). No music (nor art nor culture in general) emerges *ex nihilo*; everything we create reflects our experiences. The music in this lesson represents that which the earliest jazz musicians would have been familiar with.

  Note that none of the recordings in this lesson precisely capture anything someone in 1910 would have literally heard at the time. Audio technology of the time couldn't capture the nuances that a live audience would hear; recording length was limited to a few minutes at most; and the equipment to record was both expensive and not widely available to the musicians here discussed. What we mostly have instead are recordings from later years/decades that, to some extent, still exemplify the musical practices that would synthesize and form the earliest jazz.
...
- heading: African Drumming
  prose: |-
    ...
    - a close relationship with dancing
    - call-and-response forms
    - [improvisation](vocabulary.html#improvisation)
    ...
    *Author's note: I'm considering removing this section from this lesson. I increasingly feel like the link between African music and jazz is tenuous. Mostly for the reason noted above: slavers deliberately tried to prevent the cultural traditions of those they kidnapped from making it across the ocean. Also, the traits noted above as similar to jazz are, in fact, found in musical traditions around the world, in nearly every time and place (including in much European music). I sometimes suspect that historians cite African music as an ancestor of jazz mostly to acknowledge the ancestry of its innovators. But while the people who created jazz were (mostly) of African descent, culture does not travel through genetics, and jazz's specifically musical connection to Africa is not nearly as clear to me as is its connection to early African-American music - work songs, spirituals, field hollers, the blues, etc. I'm still thinking about this.*
- heading: Hausa Drummers
  ...
  - title: Simpa (Fire)
    ...
    recorded: '1964'
    album: Folk Music of Ghana, 1964
    spotify: 3OI8MGOkr2o2znpNYO5BLY
    intro: |-
      Three groups of percussion—high-pitched shakers and scrapers, mid-range tuned drums, and deep low-pitched drums—layer together to create a polyrhythmic collage. The parts interlock to create a consistent groove, each member playing their prescribed role, with the lead (master) drummer left some room for thematic variation.

      In the liner notes to *Roots of Black Music in America*, Charters offers this description:

      > "'Simpah,' with its strong surging rhythm, and its dramatic bursts of sound, has... multi-leveled texturing. There is the regular rhythm of the shakers or scrapers, the deeper drums generally accenting what would be the European third and fourth beats of the phrase, counting the beats of the scrapers as 4/4. The middle drums have a shifting, crossing pattern. ...And within these patterns there is continual shift and emphasis." [p. 2](bibliography.html#charters-1972)
    guidenote: |-
    ...
    guide: |-
      ...
      1:15 | The following calls and responses are shorter phrases. Here, we get both in quick succession, twice.
  ...
  notes: |-
    ...
    - "Simpah" was also released on a Smithsonian Folk Ways compilation from 1974 called [Black Roots of American Music](https://folkways.si.edu/roots-of-black-music-in-america/african-american-music/album/smithsonian). This release was intended to help listeners connect contemporary Black American music with its African roots. Informative liner notes for this compilation can be viewed [here](https://folkways-media.si.edu/docs/folkways/artwork/FW02694.pdf). This compilation provides a great next step for those interested in studying this subject further.

  sources:
  - {ref: hasse-lathrop-2012, pages: 29}

- heading: Work Songs
  prose: |-
    In times where arduous and repetitive manual labor required precise coordination between two or more people, a *work song* might be called for. Consider the [sea shanties](https://en.wikipedia.org/wiki/Sea_shanty) sung by European and American laborers on merchant sailing ships, or the call-and-response [military cadences](https://en.wikipedia.org/wiki/Military_cadence) that accompany army marching drills even today. Such songs need a steady and predictable rhythm whose tempo precisely matches that of the work being done and a simple melody that can be sung by untrained singers.

    Enslaved Africans in the United States developed work songs as a means of coordination, motivation, and social bonding to accompany tasks like axe chopping, hammer swinging, boat rowing, and plantation work. Since these songs were developed and passed on primarily through oral (and aural) tradition, and existed mostly before recording technology could capture them, we can assume that most were lost to time. However, an 1867 publication [*Slave Songs of the United States*](https://en.wikipedia.org/wiki/Slave_Songs_of_the_United_States) preserved, with necessarily imprecise notation, many such songs, and future work by musicologists has identified characteristics of them that, in retrospect, must have contributed to the development of jazz, decades later.

    In particular, African-American work songs typically feature [call-and-response](vocabulary.html#call-and-response) phrasing, some degree of [improvisation](vocabulary.html#improvisation), and expressive, microtonal vocal phrasing reminiscent of [blue notes](vocabulary.html#blue-notes). These characteristics are all present to some extent in early (and even contemporary) jazz. In particular, Gunther Schuller identifies work songs as relatives and progenitors of [the blues](#the-blues) (discussed below), which had, and still has, strong ties to jazz. [(Gunther Schuller, *Early Jazz* , 1968, p.37)](bibliography.html#schuller-1968)
- heading: Huddie "Lead Belly" Ledbetter
  artists:
  - name: Huddie "Lead Belly" Ledbetter
    born: 1888
    died: 1949
  prose: |-
    Huddie Ledbetter, better known as Lead Belly, was born either 1885 or 1888 in Louisiana. He was a folk and blues musician who lived most of his life in Texas, then a part of the American frontier. Ledbetter was frequently in trouble with the law, and served several jail and prison sentences over the course of his life. In 1933, he was halfway through a 30-year prison sentence for murder when he was visited by musicologists John A. Lomax, and his son Alan, who had come to the prison in search of folk music to document. They recognized Ledbetter as a great talent and, while he was still in prison, made several recordings.[^"Lead Belly/Lomax Chronology", Cultural Equity](https://www.culturalequity.org/alan-lomax/friends/ledbetter/chronology#tab-791-2)

    John Lomax was a traveling lecturer. Beginning in late 1934, he arranged for Ledbetter to perform during his lectures and fundraising attempts. On January 3, 1935, the *New York Herald Tribune* published a flattering review of one such lecture, writing, "Lead Belly made a tremendous hit when he sang before the Modern Language Association in Philadelphia last friday."[^"Huddie Ledbetter (Lead Belly)", Cultural Equity](https://www.culturalequity.org/alan-lomax/friends/ledbetter) Two days later, Lomax officially became Ledbetter's manager, and later that month, Ledbetter made the first of several studio recordings.

    In March of the same year, following financial and legal disputes between Ledbetter and John Lomax, the two parted ways. Over the next decade, Lead Belly garnered fame as a folk musician. His signature song (though not his original composition) "Goodnight, Irene" became a major hit - especially as later recorded by [the Weavers](https://open.spotify.com/track/45zQMiUWAzODSGbIRulxBj?si=818fac219dd0432c). Unfortunately, Ledbetter did not live to see financial success commensurate with his fame; the Weavers' recording was released in 1950, the year after Ledbetter's death.[^"Huddie Ledbetter (Lead Belly)", Cultural Equity](https://www.culturalequity.org/alan-lomax/friends/ledbetter)
  tracks:
  - title: Juliana Johnson
    ...
    guidenote: |-
      Listen to the straightforward melody and harmonic progression (I-V), and Lead Belly's vocalized imitation of the sound of an axe chop ("wah!"). In a work context, the "wah" would be the *response* to the singer's *call* of the verse. The consistent rhythmic vocalization and simple harmonic pattern presage the groove orientation and improvisational spirit of jazz.
    guide: |-
  ...
  notes: |-
    - Lead Belly was filmed on only two occasions. The first occurred in 1935 for an episode of the video newsreel [*The March of Time*](https://en.wikipedia.org/wiki/The_March_of_Time). The sequence is a staged depiction of Ledbetter's meeting with Lomax at Angola prison and subsequent partnership agreement. Note that, though the speaking clips were recorded live, the music (a performance of "Goodnight, Irene") was not - it was edited together later. Individual clips of this sequence are available from [Getty Images](https://www.gettyimages.com/search/2/film?phrase=lead%20belly&sort=newest&suppressfamilycorrection=true&license=rf%2Crr&artistexact=The%20March%20of%20Time). The full sequence is also hosted on YouTube:

      @video(lead-belly-march-of-time)

    - There's a 1976 biopic about Ledbetter, called "[Leadbelly](https://en.wikipedia.org/wiki/Leadbelly_(film))".

  sources:
  - {ref: mccalla-2000, pages: 8}

- heading: The Blues
  prose: |-
    "The blues" can mean many things, and these meanings overlap. It can refer to:

    - the general emotional content of a song, characterized by a sense of melancholy
    - specific melodic content, characterized by "bent" and "blue" notes and the mixing of minor and major sonorities
    - a genre of music, related to jazz but in many ways distinct, typified by the music of artists like B.B. King and Muddy Waters
    - a specific 12-bar song form, for which dozens of variations exist, and upon which countless melodies have been played and lyrics sung.

    Like jazz, blues music is quintessentially American. Although its roots can plausibly be traced all the way back to Africa, it was in the United States, particularly the Delta region of Mississippi, that the blues coalesced into the form we still play today.

    Many blues songs, including the two featured in this lesson, follow a 12-bar **AAB** form, with four bars each section. A phrase is played or sung, then repeated, and then expanded upon or contextualized by a consequent third phrase. This happens in both the melody and lyrics, but the latter is easier to demonstrate with text. Consider the lyrics to \"St. Louis Blues\", as first published in 1914:
    ...
    - **Early/Country Blues**, typically performed by one musician (usually a man) singing and accompanying himself on guitar. See [Robert Johnson, "Hellhound On My Trail"](#hellhound-on-my-trail).
    - **Classic/City Blues**, typically performed by a singer (often a woman) with accompanying instrumentalists. See [Bessie Smith, "St. Louis Blues"](#st-louis-blues).

    Throughout this course, you'll find many other examples of blues material as interpreted by jazz musicians.
...
- heading: Robert Johnson
  ...
  - name: Robert Johnson
    ...
    died: 1938
  prose: |-
    Robert Johnson lived for fewer than 28 years, and produced only 29 distinct songs (plus 12* alternate takes), over a total of two recording sessions in his short career (in 1936 & 1937). Nevertheless, even this scant recording history has been enough for later listeners to dub him the "King of the Delta Blues."

    Each of his 41* recordings reflects a style that typifies what is variously called early, country, and Delta blues: one man singing, accompanying himself with a guitar, and almost exclusively playing songs that conform to the standard 12-bar blues form. Indeed, listen through Johnson's complete recordings, and you'll quickly identify musical elements common to each one, including (but not limited to):

    - an **AAB** lyric structure
    - "blue" notes, achieved by bending the strings of his guitar
    - free and varied melodic interpretation; he rarely sings the same line the same way
    - a loose approach to meter; try to count along, and you'll notice not all measures have four beats – an advantage of accompanying yourself is the ability to alter the form spontaneously.
  ...
  - title: Hellhound on My Trail
    ...
    spotify: 3jCMMPQub1LMN76EzRLLrK
    intro: |-
      Lyrics like these probably fueled the crossroads legend. Note their proximity to an AAB structure, though it's imprecise.

      > **[A]** I got to keep moving, I got to keep moving, blues fallin' down like hail, blues fallin' down like hail  
      > __[A*]__ Umm-mm-mm-mm, blues fallin' down like hail, blues fallin' down like hail  
      > **[B]** And the day keeps on worrin' me, there's a hellhound on my trail, hellhound on my trail, hellhound on my trail
...
- heading: Bessie Smith
  ...
  - name: Bessie Smith
    ...
    died: 1937
  prose: |-
    Called the “Empress of the Blues,” Bessie Smith practically defines the sound of classic blues. She was the protégé of [Ma Rainey](https://en.wikipedia.org/wiki/Ma_Rainey), herself a very successful blues performer and pioneer of the classic/city blues style. Smith performed with Rainey as part of the [Rabbit's Foot Company](https://en.wikipedia.org/wiki/The_Rabbit%27s_Foot_Company), a traveling vaudeville show, before embarking on a solo career. She was a hit, attracting even mixed race audiences, and for a time was likely the highest paid Black performing artist in the world [p. 41](bibliography.html#gioia-2008).
    ...
    Her personal life was not easy. She lost both of her parents and one brother before her tenth birthday, leaving her older sister to raise her. Her first performances - at around the age of twelve - were to the guitar accompaniment of her brother. A series of record deals with Columbia propelled her to stardom by the mid 1920s, though her popularity waned in the following decade. Her career ended when she died in a car accident while traveling to a performance.
  sources:
  ...
  - title: St. Louis Blues
    ...
    intro: |-
      St. Louis Blues is likely the single most recorded blues song in history, and (as of 2019 at least) the second most recorded jazz song, with 2,191 recordings listed on the [Tom Lord discography](https://www.lordisco.com/). As Ted Gioia notes in *The Jazz Standards*, "only 'Silent Night' was recorded more frequently during the first half of the twentieth century." [p. 355](bibliography.html#gioia-2012) As a result of the composition's popularity, its composer, W.C. Handy, is often dubbed "The Father of the Blues."
...
- heading: Ragtime
  prose: |-
    ...
    Among all the musical genres discussed in this lesson, ragtime potentially has the strongest connection to early jazz. The transition was mostly seamless; from roughly 1900 to 1917, ragtime's popularity diminished at the rate jazz's rose. One could argue "not only that jazz replaced ragtime but also that ragtime *became* early jazz at a later stage."[p.26](bibliography.html#martin-waters-2006)
...
- heading: Scott Joplin
  ...
  - name: Scott Joplin
    ...
    died: 1917
  prose: |-
    Scott Joplin is the composer most associated with ragtime, and his compositions are considered "the pinnacle of the classic ragtime canon."[p. 23](bibliography.html#martin-waters-2006). Born in Texarkana, TX, he lived most of his life in Missouri, where he attracted many students and colleauges, and subsequently which became the cultural hub of ragtime.[p.20](bibliography.html#gioia-2011). He worked as a professional pianist, and later as a music teacher and even singer.

    He composed "Maple Leaf Rag" around 1897, and two years later it began to surge in popularity. It sold more than a million copies - the first piece ever (of any style) to do so. As Gioia notes, "this figure [becomes] all the more stunning when one realizes that there were fewer than 100,000 professional musicians and music teachers in the United States at the time."[p.23](bibliography.html#gioia-2011)

    Perhaps part of Joplin's breakout success, argues Karlton Hester, can be attributed simply to his ability to notate the musical practice that was previously only transmitted aurally: "Nobody knew how to write the syncopated rags down on paper. Joplin was the first musician to notate genuine ragtime rhythms."[p.102](bibliography.html#hester-2004)

    Joplin had ambitions to elevate ragtime, in the public consciousness, to the level of concert hall art music, alongside [Debussy](https://en.wikipedia.org/wiki/Claude_Debussy), [Strauss](https://en.wikipedia.org/wiki/Richard_Strauss), and [MacDowell](https://en.wikipedia.org/wiki/Edward_MacDowell). To that end, he wrote an opera, [*Treemonisha*](https://en.wikipedia.org/wiki/Treemonisha), which, though it was performed only once during his lifetime, won him a posthumous Pulitzer Prize in 1976.
  tracks:
  - title: Maple Leaf Rag
    ...
    guide: |-
      ...
      2:51 | D
  notes: |-
    - Although no direct recordings of Joplin exist, there is a way to hear him. Before audio recordings existed, there were player pianos. These were pianos outfitted with an air-powered mechanism that let it play itself - without a pianist! The music was encoded in long, rolled up sheets of paper called "piano rolls," into which many small holes were punched, each recording a key press. The rolls could be created live such that their subsequent playback would fully reproduce the original performance. Audio is never encoded directly. (A strong analogy can be made to the contemporary [MIDI](https://en.wikipedia.org/wiki/MIDI) format, which similarly encodes only instructions for playback, not audio itself.)
      ...
      As you might notice, it's not the best performance. The tempo varies, and the technique is sloppy. Writings from his time suggest Joplin was an accomplished pianist, but in this last year of his life, he was quite sick with syphilis, so his poor performance here was likely the result of his illness.

    - One of the great historical treasures in jazz history is a series of recordings of Jelly Roll Morton, made in 1938 by Alan Lomax. In one of these recordings Morton (a pioneer of jazz whom we'll discuss in the next lesson) performs "Maple Leaf Rag" in two contrasting styles:
    
      - first, "the way they played it in Missouri", which, though faster than Joplin would likely have preferred, reflects the performance practices of ragtime as Morton remembers it.  

      @audio(morton-st-louis-scene)

      - second, "the style that I played it in New Orleans," which Morton claims is more representative of jazz, noting, "In my estimation it’s a vast difference."
...
- heading: New Orleans Brass Bands
  prose: |-
    Brass bands are named for their instrumentation - composed mostly of brass instruments like trumpets, tubas, trombones - plus saxophones (and/or clarinets) and percussion. Even today, they are common in New Orleans, performing on stages or in the street, entertaining parties and festivals, and leading parades and (notably) funeral processions.
    
    The American brass band has roots at least as old as America itself. But it was around the time of the American Civil War that they surged in popularity in New Orleans. In the mid-19th century, it was common for American towns to form community brass bands that would, on occasion, accompany the training drills of local militias.[p.12](bibliography.html#troiano-2021). Such martial music became a major part of the American Civil War - brass bands performed to maintain morale during long marches, rest, and even combat.[p.13](bibliography.html#troiano-2021) During the war, New Orleans was occupied by federal forces whose numerous brass bands had a large influence on the city and its musical future.[^Karl Koenig, Jazz Essays, Vol. 1, basinstreet.com](http://basinstreet.com/wp-content/uploads/2016/09/essays1.pdf)
    
    Over time, brass bands in New Orleans took on a cultural significance distinct from that of the rest of the country. Of special note is their function in funeral processions. They begin with slow and somber dirges. But as the procession continues, they switch to upbeat, higher tempo dance music. The mournful air becomes celebratory, and attendees begin to dance, clap, sing, and play their own instruments as they follow the band in a **second line**.

    It's important to note that no recordings of this music exist before the mid-1940s. What we *do* have are testimonies from musicians of the time and recordings from later decades by those who attempt to replicate how they and other bands sounded in decades past. To get a sense of what a listener in 1910 might have heard, we need to triangulate using several sources.
...
- heading: Bunk Johnson
  ...
  - name: Bunk Johnson
    ...
    died: 1949
  prose: |-
    Early jazz, like that discussed in the next lesson, came of age in the 1910s and thrived through the 1920s. But by the late 1930s, this particular style had all but faded from history.[^"The Great Jazz Revival", The San Francisco Traditional Jazz Foundation Collection](https://exhibits.stanford.edu/sftjf/feature/the-great-revival) In the 1940s, several jazz historians became interested in documenting and reviving these early musical practices. To that end, they began searching for and interviewing musicians from that time. They found, among others, Willie "Bunk" Johnson. 

    Johnson boasted an impressive resume: he was a working musician in New Orleans during the first decades of the 20th century, and a pioneer in the development of jazz. He played with brass bands, circus bands, dance orchestras, and, of course, jazz bands. He worked with Louis Armstrong, Buddy Bolden, and a host of now-famous jazz innovators. But by the time he was "rediscovered", he hadn't played trumpet for nearly a decade, having lost his teeth and, consequently, his ability to play.[^Hal Smith, "First Generation Jazzmen", The San Francisco Traditional Jazz Foundation Collection](https://exhibits.stanford.edu/sftjf/feature/first-generation-jazzmen)
  ...
  - title: In Gloryland
    ...
    guidenote: |-
      ...
      Listen to the gradual increase in “heat” (jazz feeling) as the song progresses - especially noticeable in the bass drum and in the final (6th) chorus.
      
      Try to pick out an individual instrument, then listen to how that instrument fits within the polyphonic tapestry. The trumpets drive the melody, the tuba plays a steady 2-feel bass, the trombone improvises counterlines in the lower register, while the clarinet does the same in higher register.
    guide: |-
  ...
  notes: |-
      - In 1942, Johnson sat down for an interview where he talks about his early music education, first bands, and his time with the legendary Buddy Bolden:

       @audio(bunk-johnson-talking-records)